...
def main():
  ...
  parser.add_argument("input", metavar="INPUT", help="Source file to compile")

  parser.add_argument(
      "--dump-tokens", action="store_true", help="Dump lexed tokens and exit")

  parser.add_argument(
      "--dump-ast", action="store_true", help="Dump parsed syntax and exit")
  ...
  parser.add_argument("--dump-ir", action="store_true", help="Dump IR and exit")
  ...
  if args.split_input_file:
    with open(args.input, "r") as f:
      splits = re.split(r'[ ]*//[ ]*-----.*$', f.read(), flags=re.MULTILINE)
    any_failed = False
    padding = ""
