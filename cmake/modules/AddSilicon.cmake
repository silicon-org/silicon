...
function(add_silicon_dialect dialect dialect_namespace)
  ...
  mlir_tablegen(${dialect}Attributes.cpp.inc -gen-attrdef-defs -typedefs-dialect=${dialect_namespace})
  mlir_tablegen(${dialect}Attributes.h.inc -gen-attrdef-decls -typedefs-dialect=${dialect_namespace})
