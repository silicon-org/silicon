...
function(add_silicon_dialect dialect dialect_namespace)
  ...
  mlir_tablegen(Attributes.cpp.inc -gen-attrdef-defs -attrdefs-dialect=${dialect_namespace})
  mlir_tablegen(Attributes.h.inc -gen-attrdef-decls -attrdefs-dialect=${dialect_namespace})
  mlir_tablegen(Dialect.md -gen-dialect-doc -dialect=${dialect_namespace})
  mlir_tablegen(Passes.md -gen-pass-doc -dialect=${dialect_namespace})
  add_public_tablegen_target(Silicon${dialect}Headers)
  add_dependencies(silicon-headers Silicon${dialect}Headers)
endfunction()
